// Custom element rendering India's outline (real TopoJSON geometry) with pins
// for BrandMesh's coverage regions. Requires d3 + topojson-client, loaded via
// the CDN <script> tags in index.html before this file.
